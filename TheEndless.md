...
The App may offer in-app purchases. All in-app purchases are processed entirely by Apple through the App Store. We do not receive, collect, or store any of your payment information, billing details, or purchase history. Apple may process your data in accordance with its own privacy policy.
Apple may also collect certain aggregated or diagnostic information about your use of the App Store and your device (such as download counts, crash reports, or usage statistics) where permitted by your device settings. We do not have access to any personally identifying information through such data. Please review Apple’s Privacy Policy at: https://www.apple.com/legal/privacy/
...
4.1 App Design and Local Storage. To maximize the protection of your privacy, we do not require you to create an account, and we do not collect or store your personal data or usage data on our servers. The only network communications involving the App are limited to what is necessary for Apple’s in-app purchase system: when the App retrieves in-app purchase product or price information from Apple, or when a purchase transaction is processed, the relevant in-app purchase data is transmitted between your device and Apple’s servers. All such in-app purchase data is handled by Apple’s in-app purchase system; to the extent the App receives transaction data locally to complete your purchase, we do not collect, upload, or store that data. All game progress, character data, virtual items, settings, and other content generated through your use of the App (“User Data”) are stored solely and exclusively on your iOS device. As a necessary consequence of this design, your User Data cannot exist independently of the current device unless you back up the device through iTunes(or Finder on macOS Catalina and later).

4.2 Your Responsibility for Backup. YOU UNDERSTAND AND CONFIRM that because the App does not collect User Data, you bear full responsibility for the security and backup of your game progress, virtual items, and other User Data. Your User Data will be permanently lost, and we will be unable to recover it for you, if you perform any of the following actions: (a) uninstalling or deleting the App without first creating a complete backup of your current device data via iTunes (or Finder on macOS Catalina and later); or (b) replacing or resetting your device without restoring from a valid backup that contains the App data. We strongly recommend that you perform a complete device backup via iTunes (or Finder on macOS Catalina and later) before deleting the App or changing devices.
...
### [Home](https://yytechplayer.github.io/TheEndless) 
